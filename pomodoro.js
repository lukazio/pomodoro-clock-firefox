...
window.onload = () => {
	...
	if (!(localStorage.customColorBtn === undefined))
		document.documentElement.style.setProperty('--main-color', localStorage.getItem("customColorBtn"));
	if (!(localStorage.customColorBtnHover === undefined))
		document.documentElement.style.setProperty('--btn-hover-color', localStorage.customColorBtnHover);
	if (!(localStorage.customColorBg === undefined))
		document.documentElement.style.setProperty('--main-bg-color', localStorage.customColorBg);
	if (!(localStorage.customColorFace === undefined))
		document.documentElement.style.setProperty('--clock-face-color', localStorage.customColorFace);
	if (!(localStorage.customColorSecond === undefined))
		document.documentElement.style.setProperty('--clock-seconds-color', localStorage.customColorSecond);
	if (!(localStorage.customColorMinute === undefined))
		document.documentElement.style.setProperty('--clock-minutes-color', localStorage.customColorMinute);
	if (!(localStorage.customColorMark === undefined))
		document.documentElement.style.setProperty('--clock-mark-color', localStorage.customColorMark);
